...
reg [31:0] opa = 32'h41a00000 ; //20
reg [31:0] opb = 32'h42a80000; // 2
...
fpu #(.BIT_SIZE(BIT_SIZE), .EXP_SIZE(EXP_SIZE), .MANT_SIZE(MANT_SIZE), .BIAS(BIAS1) ) bit_32(clk, fpu_rmode, fpu_op, opa, opb, out, snan, qnan, inf, ine, overflow, underflow, div_by_zero, zero);
